...
# Cálculo dinámico del tamaño de ventana según el mapa
...
class Jugador:
    def __init__(self, img, fila, col):
        ...
        self.trail = []
        self.intencion = [0, 0]  # dirección deseada por el jugador
...
class Jugador:
    def __init__(self, img, fila, col):
        ...
        self.fila = fila
        self.col = col
        self.dir = [0, 0]         # Dirección actual (x, y)
        self.intencion = [0, 0]   # Dirección deseada (x, y)
        self.trail = []
    ...
    def mover(self, dx, dy):
        self.intencion = [dx, dy]  # guarda la dirección deseada
    ...
    def actualizar(self):
        ...
        # Mover en la dirección actual si se puede
...
jugador = Jugador(pygame.Surface((CELL_WIDTH, CELL_HEIGHT)), spawn_fila, spawn_col)
...
def main():
    ...
    while corriendo:
        ...
        jugador.dibujar()
        pygame.draw.rect(Display_Surface, (255, 0, 0), (cabra_pos[1]*CELL_WIDTH, cabra_pos[0]*CELL_HEIGHT, CELL_WIDTH, CELL_HEIGHT))
